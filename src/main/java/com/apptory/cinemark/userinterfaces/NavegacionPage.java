...
public class NavegacionPage {
    public static final Target COMPRA_EXITOSA = Target.the("Mensaje de espera al cargar la app").located(new AppiumBy.ByAccessibilityId(" ¡Tu Compra ha sido confirmada! "));
    ...
    public static final Target BOTON_OBTENER_UBICACION = Target.the("Botón para dar permisos de ubicación a la app").located(new AppiumBy.ByAccessibilityId("PERMITIR OBTENER UBICACIÓN"));
    ...
    public static final Target BOTON_LOGOUT = Target.the("Campo que muestra el usuario autenticado").located(new AppiumBy.ByAccessibilityId("Cerrar sesión"));
    public static final Target BOTON_FINALIZAR = Target.the("Botón para finalizar el proceso").located(new AppiumBy.ByAccessibilityId("FINALIZAR"));
